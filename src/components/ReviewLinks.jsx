      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          >
            ...
            <span className="font-bold text-[#1a1a1a] text-lg">Google</span>
          </Link>
          ...
          >
             <svg viewBox="0 0 24 24" className="w-6 h-6 fill-[#00aa6c]" xmlns="http://www.w3.org/2000/svg">
             ...
             <span className="font-bold text-[#1a1a1a] text-lg">TripAdvisor</span>
          </Link>
          ...
          >
            ...
            <span className="font-bold text-[#1a1a1a] text-lg">Facebook</span>
          </Link>
