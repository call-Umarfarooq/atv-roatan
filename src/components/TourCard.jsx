            ...
            <div className="flex items-end justify-between gap-2 w-full">
                <div className="flex flex-col min-w-0">
                    ...
                    <div className="flex items-baseline gap-1 sm:gap-2">
                        <span className="text-[#153b2d] font-black text-[26px] sm:text-[28px] leading-none">{currency}{price}</span>
                        {cutoff_price && (
                ...
                <Link href={`/product/${slug}`} className="bg-[#00694B] shrink-0 whitespace-nowrap cursor-pointer hover:bg-[#1f4232] text-white px-3 sm:px-5 py-1 rounded-[32px] transition-all flex items-center gap-1.5 shadow-md">
