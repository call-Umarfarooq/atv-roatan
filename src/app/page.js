...
<div className="flex mb-6 sm:mb-6 flex-wrap items-center justify-center gap-1 sm:gap-3 mt-4 sm:mt-5">              <a
                ...
                className="flex items-center gap-2 px-5 py-1 sm:py-2.5 rounded-full  text-[10px] sm:text-sm sm:font-bold text-white bg-[#80E142] hover:bg-[#005a3c] shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
              >
