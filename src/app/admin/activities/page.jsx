  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
            <h1 className="text-2xl h11 font-bold text-[#1a1a1a]">Activities</h1>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              ...
              <div className="relative">
                  ...
                  <input type="text" placeholder="Search activities..." className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#00694B]" />
              </div>
          </div>
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-lg bg-gray-100 overflow-hidden shrink-0">
                                            <img src={getImageUrl(activity.image)} alt={activity.image_alt || activity.title} className="w-full h-full object-cover" />
                                        </div>
