      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              ...
              <div className="relative">
                  ...
                  <input type="text" placeholder="Search tours..." className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#00694B]" />
              </div>
          </div>
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-lg bg-gray-100 overflow-hidden shrink-0">
                                            <img src={getImageUrl(tour.image_url)} alt={tour.image_alt || tour.title} className="w-full h-full object-cover" />
                                        </div>
                                            <Link href={`/product/${tour.slug}`} target="_blank" className="hover:text-[#00694B] transition-colors block">
